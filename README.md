...
# 🚀 My Projects :
1. [AWS Serverless Web Application](#serverless-web-application)
...
5. [GRC Assessment - gsheets](#grc-assessment-gsheets)
6. [GRC Assessment - retool](#grc-assessment-retool)
7. [Access Review - gsheets](#access-review-gsheets)
8. [Control Inventory - gsheets](#control-inventory-gsheets)

<a name="serverless-web-application"></a>

---
## 1. [AWS Serverless Web Application](https://github.com/MiguelAngelHorta/Serverless-Web-Application/tree/main)
...
## 3. [Security Control Inventory App (frontend + backend)](https://github.com/MiguelAngelHorta/API-Server)
...
## 4. [Security Control Inventory App (frontend)](https://github.com/MiguelAngelHorta/CRUD-App)
